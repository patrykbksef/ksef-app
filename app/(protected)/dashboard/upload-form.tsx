  ...
  return (
    <form action={formAction} className="space-y-4">
      <input
        ...
        required
        disabled={disabled}
        className="text-muted-foreground block w-full text-sm file:mr-4 file:rounded-md file:border-0 file:bg-secondary file:px-4 file:py-2 file:text-base file:font-medium"
      />
